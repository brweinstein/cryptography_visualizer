...
export default function RSAPage() {
  ...
  return (
    <div className="space-y-6">
      <Navigation title="RSA Cryptosystem" showBackButton />
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-[var(--ui-text)]">RSA Visualization</h1>
        <p className="text-sm text-[var(--ui-muted)]">Explore RSA key generation and modular exponentiation mappings</p>
      </div>
